...
export default function TransactionBondsList({ UploadModalOpen }) {
  ...
  const createRowData = (value) => {
    ...
    Object.values(value?.content).map((item, index) => {
      let SingleData = {
        ...
        rtaCode:
          item.rtaCode === null || item.rtaCode === "" ? `-` : item.rtaCode,
        bseCode:
          item.bseCode === null || item.bseCode === "" ? `-` : item.bseCode,
        nseCode:
          item.nseCode === null || item.nseCode === "" ? `-` : item.nseCode,
        masterProductClassificationId:
          item.masterProductClassificationId === null ||
          item.masterProductClassificationId === ""
            ? `-`
            : item.masterProductClassificationId,
        instrumentDetailsId:
          item.instrumentDetailsId === null || item.instrumentDetailsId === ""
            ? `-`
            : item.instrumentDetailsId,
        holdingEntityId:
          item.holdingEntityId === null || item.holdingEntityId === ""
            ? `-`
            : item.holdingEntityId,
        instrumentSourceId:
          item.instrumentSourceId === null || item.instrumentSourceId === ""
            ? `-`
            : item.instrumentSourceId,
        isinCode:
          item.isinCode === null || item.isinCode === "" ? `-` : item.isinCode,
        instrumentRtaCode:
          item.instrumentRtaCode === null || item.instrumentRtaCode === ""
            ? `-`
            : item.instrumentRtaCode,
        instrumentName:
        ...
        transactionTypeId:
          item.transactionTypeId === null || item.transactionTypeId === ""
            ? `-`
        ...
        userTransactionNumber:
          item.userTransactionNumber === null ||
        ...
        serviceProviderAccountType:
          ...
          item.serviceProviderAccountType === ""
            ...
            : item.serviceProviderAccountType,
        couponDate:
          item.couponDate === null || item.couponDate === ""
            ? `-`
            : item.couponDate,
        maturityDate:
          item.maturityDate === null || item.maturityDate === ""
            ? `-`
            : item.maturityDate,
        distributor:
          item.distributor === null || item.distributor === ""
            ? `-`
            : item.distributor,
        issueOpenDate:
          item.issueOpenDate === null || item.issueOpenDate === ""
            ? `-`
            : item.issueOpenDate,
        interestPaymentFrequency:
          item.interestPaymentFrequency === null ||
          item.interestPaymentFrequency === ""
            ? `-`
            : item.interestPaymentFrequency,
        cumulativeFdPaymentFrequency:
          item.cumulativeFdPaymentFrequency === null ||
          item.cumulativeFdPaymentFrequency === ""
            ? `-`
            : item.cumulativeFdPaymentFrequency,
        accrualFrequency:
          item.accrualFrequency === null || item.accrualFrequency === ""
            ? `-`
            : item.accrualFrequency,
        accrualInterestPaidToThirdParty:
          item.accrualInterestPaidToThirdParty === null ||
          item.accrualInterestPaidToThirdParty === ""
            ? `-`
            : item.accrualInterestPaidToThirdParty,
        trxnDisc:
          item.trxnDisc === null || item.trxnDisc === "" ? `-` : item.trxnDisc,
        opSecurityId:
          item.opSecurityId === null || item.opSecurityId === ""
            ? `-`
            : item.opSecurityId,
        opInstrumentName:
        ...
        opAccountId:
          item.opAccountId === null || item.opAccountId === ""
            ? `-`
            : item.opAccountId,
        opClientName:
          item.opClientName === null || item.opClientName === ""
            ? `-`
            : item.opClientName,
        opTransactionDesc:
          item.opTransactionDesc === null || item.opTransactionDesc === ""
            ? `-`
            : item.opTransactionDesc,
        opClosingBalance:
          item.opClosingBalance === null || item.opClosingBalance === ""
            ? `-`
            : item.opClosingBalance,
        opDailyDividendAccruedAmount:
          item.opDailyDividendAccruedAmount === null ||
          item.opDailyDividendAccruedAmount === ""
            ? `-`
            : item.opDailyDividendAccruedAmount,
        opBrokerAccNo:
          item.opBrokerAccNo === null || item.opBrokerAccNo === ""
            ? `-`
            : item.opBrokerAccNo,
        transactionDate:
        ...
        opDistributorId:
          item.opDistributorId === null || item.opDistributorId === ""
            ? `-`
            : item.opDistributorId,
        opPolicyTenure:
          item.opPolicyTenure === null || item.opPolicyTenure === ""
            ? `-`
            : item.opPolicyTenure,
        opBuiltUpArea:
          item.opBuiltUpArea === null || item.opBuiltUpArea === ""
            ? `-`
            : item.opBuiltUpArea,
        opRentalIncome:
          item.opRentalIncome === null || item.opRentalIncome === ""
            ? `-`
            : item.opRentalIncome,
        opAddress:
          item.opAddress === null || item.opAddress === ""
            ? `-`
            : item.opAddress,
        opCity: item.opCity === null || item.opCity === "" ? `-` : item.opCity,
        opState:
          item.opState === null || item.opState === "" ? `-` : item.opState,
        opAddressType:
          item.opAddressType === null || item.opAddressType === ""
            ? `-`
            : item.opAddressType,
      };
      ...
      try {
        const response = await axiosInstance.get(
          ...
          value + "/" +  filterData.label +
            `?insType=BOND&page=${currentPage}&size=${perPagesize}`
        );
  ...
  const fetchFilter = async () => {
    try {
      const response = await axiosInstance.get(
        Apiurl.globalSearchFilter + "/" + "TRANSACTION_BOND"
      );
      let result = response.data;
      setAllFilter([]);
  ...
  const fetchData = async (getcurrentPage, getperPagesize) => {
    ...
    try {
      ...
      //         : item.instrumentSourceId,
      //     isinCode:
      //       item.isinCode === null || item.isinCode === ""
      //         ? `-`
      //         : item.isinCode,
      //     instrumentRtaCode:
      //       item.instrumentRtaCode === null || item.instrumentRtaCode === ""
      ...
      //         : item.opAddress,
      //     opCity:
      //       item.opCity === null || item.opCity === "" ? `-` : item.opCity,
      //     opState:
      //       item.opState === null || item.opState === "" ? `-` : item.opState,
      //     opAddressType:
      //       item.opAddressType === null || item.opAddressType === ""
  ...
  const columnDefs = [
    ...
    {
      headerName: "Interest Payment Frequency",
    ...
    {
      headerName: "Cumulative Fd Payment Frequency",
      field: "cumulativeFdPaymentFrequency",
      sortable: true,
      filter: true,
      minWidth: 250,
    },
    {
      headerName: "Accrual Frequency",
    ...
    {
      headerName: "Accrual Interest Paid To Third Party",
      field: "accrualInterestPaidToThirdParty",
      sortable: true,
      filter: true,
      minWidth: 350,
    },
  ...
  const handleEdit = (data) => {
    navigate(
      "/" +
        encrypt("TransactionBondsFormComponent") +
        `/${encryptData("edit")}` +
        `/${encryptData(data.id)}`
    );
  };
