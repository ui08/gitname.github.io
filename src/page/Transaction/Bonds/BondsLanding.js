...
export default function BondsLanding() {
  ...
  const handleFileUpload = async (file) => {
    ...
    let fileUploadDTO = JSON.stringify({
      ...
      userId: getUserId(),
      fileUploadType: uploadEnum.BONDS_TRANSACTION_BULK_UPLOAD,
    });
  ...
  const FileUploadwithTableItems = {
    downloadTemplateApi: `${Apiurl.downloadTransactionTemplate}`+"/"+"bondTrxnTemplate",
    downloadTemplateFileName: "BONDS TRANSACTION",
    ...
    uploadEnum: uploadEnum.BONDS_TRANSACTION_BULK_UPLOAD,
  };
