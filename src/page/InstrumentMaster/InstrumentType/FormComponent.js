...
import "./InstrumentTypeFormComponent.scss";
...
const FormComponent = ({
  ...
  const [name, description, bosCode, NSEcode, BSEcode] = watch([
    "name",
    "description",
    "bosCode",
    "NSEcode",
  ...
  const isValidCondition = name && description && bosCode && NSEcode && BSEcode;
  ...
  const handleCancel =()=>{
    navigate("/" + encrypt("InstrumentTypeList"));
  };
