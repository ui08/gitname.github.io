...
function SectorHolding() {
  ...
  const topSectionData = [
    ...
    {
      value: "70.05%",
      description: "Reliance Equity Savings G",
      stock: "Magnum NRI Invest Bong G",
    },
    {
      value: "20,389,780,000",
      description: "Reliance Equity Savings G",
      stock: "Sundaram Ultra Short Term - Reg- Growth",
    },
  ];
  ...
  const [tableData, setTableData] = useState([
    ...
    {
      schemeName: "Magnum inv ST Bond G",
      currentValue: "17.89L",
      fundPercentage: "35.15%",
      amountInvested: "1,614,360,000",
    },
    {
      schemeName: "HDFC Inflation Index Bond Fund",
      currentValue: "17.89L",
      fundPercentage: "35.15%",
      amountInvested: "1,614,360,000",
    },
                ...
                {tableData.map((row, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      <button className="button-class-div me-2 disabled">
                        SIP
                      </button>
