...
export default function VMOtherProductFormComponent() {
  ...
  function pagemode() {
    ...
    if (mode === "add") {
      modeLabel = VMPageurl.OtherProductsAdd;
    } else if (mode === "edit") {
      modeLabel = VMPageurl.OtherProductsEdit;
    } else if (mode === "view") {
      modeLabel = VMPageurl.OtherProductsview;
    } else {
  ...
  function pageFunction() {
    let component;
     ...
     if (mode === "add" && 
              RouteCurrentAuthorities([userRole.Valuation_Master_Other_Products_Create])) {
          component = <AddFormComponent />;
        } else if (mode === "edit" && 
          RouteCurrentAuthorities([userRole.Valuation_Master_Other_Products_Edit])) {
          component = <EditFormComponent />;
        } else if (mode === "view" && 
          RouteCurrentAuthorities([userRole.Valuation_Master_Other_Products_Details])) {
