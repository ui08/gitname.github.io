...
export default function FamilyClientUngroupingFormComponent() {
  ...
  function pagemode() {
    ...
    if (mode === "add") {
      modeLabel = ClientMasterPageurl.FamilyClientMappingAdd;
    } else if (mode === "edit") {
      modeLabel = ClientMasterPageurl.FamilyClientUngroupingEdit;
    } else if (mode === "view") {
      modeLabel = ClientMasterPageurl.FamilyClientMappingview;
    } else {
