...
export default function FamilyClientMappingList({ UploadModalOpen }) {
  ...
  const columnDefs = [
    ...
    },
    {
      ...
      field: "familyMasterId",
      minWidth: 150,
      maxWidth: 150,      sortable: true,
      filter: true,
      cellRenderer: (params) => {
        return params.data.familyMasterId == null ||
          params.data.familyMasterId === ""
          ? "-"
          : params.data.familyMasterId;
      },
    },
    {
      ...
      filter: true,
      cellRenderer: (params) => {
        return params.data.familyMasterName == null ||
          params.data.familyMasterName === ""
          ? "-"
          : params.data.familyMasterName;
      },
    },
  ...
  
    {
      ...
      filter: true,
      cellRenderer: (params) => {
        return params.data.familyHeadClientName == null ||
          params.data.familyHeadClientName === ""
          ? "-"
          : params.data.familyHeadClientName;
      },
    },
    {
      ...
      filter: true,
      cellRenderer: (params) => {
        return params.data.relation == null || params.data.relation === "" || params.data.relation === "N/A"
          ? "-"
  ...
  return (
    <ActionButtons
      ...
      buttonConfigs={[
        ...
        //   action: "handleEdit",
        //   show: RouteCurrentAuthorities([
        //     userRole.Client_Master_Family_Remapping_Edit,
        //   ])
        // },
      ]}
