...
export default function JointHoldingFormComponent() {
  ...
  function pagemode() {
    ...
    if (mode === "add") {
      modeLabel = "Add New Joint Holding Details  ";
    } else if (mode === "edit") {
      modeLabel = "Edit  Joint Holding Details ";
    } else if (mode === "view") {
      modeLabel = "view  Joint Holding Details ";
    } else {
