...
export default function TransactionDirectEquityLanding() {
  ...
  const handleFileUpload = async (file) => {
    ...
    let fileUploadDTO = JSON.stringify({
      ...
      userId: getUserId(),
      fileUploadType: uploadEnum.DE_TRANSACTION_BULK_DELETE_UPLOAD,
    });
  ...
  const FileUploadwithTableItems = {
    downloadTemplateApi: `${Apiurl.downloadTransactionTemplate}`+"/"+"deTrxnTemplateForDeletion",
    downloadTemplateFileName: "TRANSACTION DIRECT EQUITY DELETE",
    ...
    uploadEnum: uploadEnum.DE_TRANSACTION_BULK_DELETE_UPLOAD,
  };
