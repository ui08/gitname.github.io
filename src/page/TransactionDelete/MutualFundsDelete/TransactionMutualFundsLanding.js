...
export default function TransactionMutualFundsLanding() {
  ...
  const handleFileUpload = async (file) => {
    ...
    let fileUploadDTO = JSON.stringify({
      ...
      userId: getUserId(),
      fileUploadType: uploadEnum.MF_TRANSACTION_BULK_DELETE_UPLOAD,
    });
  ...
  const FileUploadwithTableItems = {
    downloadTemplateApi: `${Apiurl.downloadTransactionTemplate}`+"/"+"mfTrxnTemplateForDeletion",
    downloadTemplateFileName: "TRANSACTION MUTUAL FUNDS DELETE",
    ...
    uploadEnum: uploadEnum.MF_TRANSACTION_BULK_DELETE_UPLOAD,
  };
