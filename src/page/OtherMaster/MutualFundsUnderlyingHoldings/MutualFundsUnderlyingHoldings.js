...
export default function MutualFundsUnderlyingHoldingsList() {
  ...
  const fetchData = async (getcurrentPage, getperPagesize) => {
    ...
    try {
      const response = await axiosInstance.get(
        Apiurl.getAllMutualFundUnderLyingHoldings +
        ...
        let SingleData = {
          ...
          masterMFSectorDTO:
            ...
            item.masterMFSectorDTO?.sector === ""
              ...
              : item.masterMFSectorDTO?.sector,
          indexMstDataDTO:
            item.indexMstDataDTO?.indexName === null ||
            item.indexMstDataDTO?.indexName === ""
              ? `-`
              : item.indexMstDataDTO?.indexName,
        };
  ...
  const columnDefs = [
    ...
    {
      headerName: "Master MF Sector DTO",
    ...
    {
      headerName: "Index Mst Data DTO",
      field: "indexMstDataDTO",
      minWidth: 350,
      sortable: true,
      filter: true,
    },
  ...
  const breadcrumbItems = [
    {
      label: "Mutual Funds - Underlying Holdings",
